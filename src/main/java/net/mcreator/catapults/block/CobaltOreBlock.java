...
import net.mcreator.catapults.item.CobaltIngotItem;
...
public class CobaltOreBlock extends CatapultsModElements.ModElement {
	@ObjectHolder("catapults:cobalt_ore")
	public static final Block block = null;
	public CobaltOreBlock(CatapultsModElements instance) {
		super(instance, 44);
	}
