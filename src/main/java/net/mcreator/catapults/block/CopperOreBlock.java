...
import net.mcreator.catapults.item.CopperIngotItem;
...
public class CopperOreBlock extends CatapultsModElements.ModElement {
	@ObjectHolder("catapults:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(CatapultsModElements instance) {
		super(instance, 23);
	}
